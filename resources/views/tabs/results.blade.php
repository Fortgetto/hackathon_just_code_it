...
<div class="main-wrp">
    <div class="ctrl-panel-wrp">
        <div class="ctrl-left">
            ...
            <a href="javascript:void(0)" @click="pop_panel()" class="fa fa-reorder" title="настройки"></a>
        </div>
        <div class="ctrl-right">
            <div class="pag-wrp">
                <a href="javascript:void(0)" class="res-count {{($user_opt->on_page)?'active':''}}">10</a>
                <a href="javascript:void(0)" class="res-count {{($user_opt->on_page)?'active':''}}">20</a>
                <a href="javascript:void(0)" class="res-count {{($user_opt->on_page)?'active':''}}">50</a>
                <a href="javascript:void(0)" class="res-count {{($user_opt->on_page)?'active':''}}">99</a>
            </div>
            <div class="pag-wrp">
                {{$paginator}}
            </div>
